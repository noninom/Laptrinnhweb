...
namespace Laptrinnhweb.Migrations
{
    ...
    [Migration("20260325025956_AddGhiChuGopBanToDatBan")]
    partial class AddGhiChuGopBanToDatBan
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Laptrinnhweb.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Laptrinnhweb.Models.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
